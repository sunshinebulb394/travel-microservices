...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleBookingNotFoundException(BookingNotFoundException ex) {
        String message = ex.getMessage();
        List<String> details = new ArrayList<>();
    ...
    protected ResponseEntity<Object> handleBusNotAvailableException(BusNotAvailableException ex) {
        String message = ex.getMessage();
        List<String> details = new ArrayList<>();
        details.add("Bus is not available");
        ApiError errors = new ApiError(message, details, HttpStatus.NOT_FOUND, LocalDateTime.now());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errors);
    }
